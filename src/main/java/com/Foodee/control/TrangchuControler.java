 ...
 * @author Admin
 */
@WebServlet(name = "TrangchuControler", urlPatterns = {"/trangchu"})
public class TrangchuControler extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        System.out.println(request.getSession().getAttribute("giohang"));
//        request.getSession().removeAttribute("giohang");
        ...
        List<SanPham> dssp = spDAO.getAllProduct();
